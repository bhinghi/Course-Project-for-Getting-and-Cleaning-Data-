## This R script accomplish the following :
## 1.merge the given training and test datasets
## 2. Extracts only the measurements on the mean and standard deviation for each measurement.
## 3. Uses the descriptive activity names to name the activities in the data set
## 4. Appropriately labels the new dataset with descriptive activity names.
