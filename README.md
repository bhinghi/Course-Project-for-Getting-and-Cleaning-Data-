...
Steps used to work on project:
    ...
    3.source("run_analysis.R") is run to generate a new file tiny_data.txt in the working directory.

    Dependency:
    run_analysis.R also installs the dependency packages automatically. It depends on reshape2 and data.table packages to run successfully.